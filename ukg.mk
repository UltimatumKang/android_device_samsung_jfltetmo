...
# name
PRODUCT_RELEASE_NAME := TMOGS4

# device
$(call inherit-product-if-exists, device/samsung/jfltetmo/full_jfltetmo.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.jfltetmo.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="jfltetmo-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/jfltetmo:4.2.2/JDQ39/573038:user/release-keys"
